...
Create rectangular bounding boxes from Labelme rectangle objects 
...
in_poly_dir = './test/rect_to_yolo/json_rectangles/'
out_yolo_dir = './test/rect_to_yolo/yolo_rbbx/'
#######################################################################
...
#######################################
# Create YOLO annotations for rectangle object json annotations
